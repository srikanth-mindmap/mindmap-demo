    ...
    >
      ...
      {slice.items.map((item, index) => (
        <div key={index} className="max-w-xs grid sm:place-items-start place-items-center">
          {item.icon && <div className="mb-5 text-center">{icons[item.icon]}</div>}
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none">
      <g stroke="#0891B2" strokeWidth="4.991" clipPath="url(#a)">
        ...
        ></path>
        <path d="M50 73.333V16.667c0-4.714 0-7.071-1.465-8.536-1.463-1.464-3.82-1.464-8.535-1.464s-7.071 0-8.535 1.464C30 9.596 30 11.953 30 16.667v56.666"></path>
        <path
          strokeOpacity="0.5"
...
function HourGlassIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none">
      <g stroke="#0891B2" strokeWidth="4.991" clipPath="url(#a)">
        <path d="M49.859 30.237L40 40l-9.859-9.763c-9.742-9.647-14.612-14.47-13.249-18.632a6.97 6.97 0 01.436-1.04C19.335 6.666 26.223 6.666 40 6.666c13.777 0 20.665 0 22.672 3.897.173.335.319.683.436 1.041 1.363 4.162-3.507 8.985-13.249 18.632z"></path>
        <path
          strokeOpacity="0.5"
